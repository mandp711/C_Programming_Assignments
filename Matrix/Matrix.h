...
// Access functions  // size() // Return the size of square Matrix M. 
int size(Matrix M); 
...
// Manipulation procedures  // makeZero() // Re-sets M to the zero Matrix state. 
void makeZero(Matrix M); 

// changeEntry() // Changes the ith row, jth column of M to the value x. // Pre: 1<=i<=size(M), 1<=j<=size(M) 
